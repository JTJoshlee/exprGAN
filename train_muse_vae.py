...
class Arguments:
    ...
    results_dir: str = "image64_results_codebookdim_256"
    logging_dir: Optional[str] = None
    resume_path: Optional[str] = None
    dataset_name: Optional[str] = None
    streaming: bool = False
    train_data_dir: Optional[str] = r"E:\style_exprGAN\data\smile_crop_64"
...
#         image_dir = "E:\style_exprGAN\data\smile_crop"
