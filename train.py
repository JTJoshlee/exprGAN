...
neutral_test_path = r"E:\style_exprGAN\ORL_data\choosed\neutral_test"
smile_test_path = r"E:\style_exprGAN\ORL_data\choosed\smile_test"
...
smile_landmark_path =  r"E:\style_exprGAN\ORL_data\choosed\smile_feature_points"
...
test_loader = DataLoader(test_test_dataset, batch_size=args.batch_size, shuffle=True, drop_last=True)
...
opt = torch.optim.RAdam(params,lr=0.0001)
...
# def train(train_loader, test_loader, num_epoch, lr):
#     clf = model